package com.hrm.test.api.data.model.example;
...
//Always main model should extend ErrorResponse in order to parse Error correctly
public class ExampleResponse extends ErrorResponse implements Serializable {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("stringValue", stringValue).append("booleanValue", booleanValue).append("intValue", intValue).append("listValue", listValue).append("objectValue", objectValue).append("listOfObjects", listOfObjects).toString();
    }
