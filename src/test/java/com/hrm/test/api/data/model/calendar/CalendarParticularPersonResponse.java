...
public class CalendarParticularPersonResponse extends ErrorResponse implements Serializable
{
    ...
    private final static long serialVersionUID = -4876816200788716945L;

    /**
     * No args constructor for use in serialization
     * 
     */
    public CalendarParticularPersonResponse() {
    }
     ...
     * @param LeaveDayType
     */
    public CalendarParticularPersonResponse(Integer ID, String FirstName, String LastName, String Gender, Integer TotalHours, Integer TotalMinutes, Object ImagesUrls, Integer RotateImage, List<Position> Positions, Integer EmploymentId, List<Object> PersonLoggingStatuses, String UssualWorkingTime, String DaySatatus, Object LeaveDayType, String LeaveDayTypeEnum, Integer EmployeeStatus) {
        super();
        this.ID = ID;
    ...
    public Object getImagesUrls() {
        return ImagesUrls;
    }

    public void setImagesUrls(Object ImagesUrls) {
        this.ImagesUrls = ImagesUrls;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CalendarParticularPersonResponse) == false) {
            return false;
        }
        CalendarParticularPersonResponse rhs = ((CalendarParticularPersonResponse) other);
